  ...
  return (
    <main className="container mx-auto my-10 p-8 bg-white shadow-md rounded-lg">
      ...
      <div className="flex flex-col items-center space-y-4">
        ...
        <h2 className="text-xl" >
          <Link href="/week-8" className="text-blue-600 hover:text-blue-800 visited:text-purple-600">
           Click to go to WEEK-8
          </Link>
        </h2>
        <h2 className="text-xl" >
          <Link href="/week-10" className="text-blue-600 hover:text-blue-800 visited:text-purple-600">
